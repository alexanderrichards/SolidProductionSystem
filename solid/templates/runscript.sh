...
dirac-dms-add-file {{ analysis_output_lfndir }}/histos/S2-histos_cycleMode_{{ id }}_${runNUMBER}_$runTime.root S2-histos_cycleMode_${runNUMBER}.root UKI-LT2-IC-HEP-disk
dirac-dms-add-file {{ analysis_output_lfndir }}/ntuples/S2-tuple_{{ id }}_${runNUMBER}_$runTime.root S2-tuple_${runNUMBER}.root UKI-LT2-IC-HEP-disk
dirac-dms-add-file {{ analysis_output_lfndir }}/ClusterExtraction/S2-ClusterExtraction_{{ id }}_${runNUMBER}_$runTime.root S2-ClusterExtraction_${runNUMBER}.root UKI-LT2-IC-HEP-disk
