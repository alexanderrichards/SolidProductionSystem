...
dirac-dms-add-file {{ analysis_output_lfndir }}/histos/S2-histos_cycleMode_${runNUMBER}_$runTime_{{ id }}.root S2-histos_cycleMode_${runNUMBER}.root UKI-LT2-IC-HEP-disk
dirac-dms-add-file {{ analysis_output_lfndir }}/ntuples/S2-tuple_${runNUMBER}_$runTime_{{ id }}.root S2-tuple_${runNUMBER}.root UKI-LT2-IC-HEP-disk
dirac-dms-add-file {{ analysis_output_lfndir }}/ntuples/S2-ClusterExtraction_${runNUMBER}_$runTime_{{ id }}.root S2-ClusterExtraction_${runNUMBER}.root UKI-LT2-IC-HEP-disk
dirac-dms-add-file {{ analysis_output_lfndir }}/logs/log_${runNUMBER}_$runTime_{{ id }}.txt log.txt UKI-LT2-IC-HEP-disk
